...
A library collection for the N32G031 microcontroller. 

You can use these libraries with the UnityMbed Base Project to quickly connect hardware to your system.

## Getting Started

1. **Select your component:** 
   Browse this repository to find the library you need to use.
2. **Download the files:** 
   Copy only the `.c` and `.h` files of your chosen hardware.
3. **Drop into your project:**
   - Place all `.c` files into the `src/` folder of your UnityMbed Base Project or the project you want to use.
   - Place all `.h` files into the `inc/` folder of your UnityMbed Base Project or the project you want to use.
...
แหล่งรวบรวมไลบรารีสำหรับไมโครคอนโทรลเลอร์ N32G031 

คุณสามารถนำไลบรารีเหล่านี้ไปใช้งานร่วมกับ UnityMbed Base Project เพื่อเชื่อมต่อฮาร์ดแวร์เข้ากับระบบของคุณได้อย่างรวดเร็ว

## วิธีการใช้งาน (Getting Started)

1. **เลือกอุปกรณ์ของคุณ:** 
   ค้นหาไลบรารีที่คุณต้องการใช้งานจาก Repository นี้
2. **ดาวน์โหลดไฟล์:** 
   ก๊อปปี้เฉพาะไฟล์ `.c` และ `.h` ของฮาร์ดแวร์ที่คุณเลือก
3. **นำไปใส่ในโปรเจค:**
   - นำไฟล์ `.c` ทั้งหมดไปวางในโฟลเดอร์ `src/` ของ UnityMbed Base Project หรือ Project ที่คุณต้องการใช้
   - นำไฟล์ `.h` ทั้งหมดไปวางในโฟลเดอร์ `inc/` ของ UnityMbed Base Project หรือ Project ที่คุณต้องการใช้
